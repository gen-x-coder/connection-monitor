...
Controle van het lokale netwerk en de router

Modem

192.168.88.1

Controle van de verbinding tussen router en modem

Internet

1.1.1.1

Controle van externe bereikbaarheid

Tweede externe controle

8.8.8.8

Vergelijking met een tweede externe bestemming
...
connection_samples.csv

Iedere meting met tijdstip, status, latency en eventuele foutmelding

connection_events.csv

Begin, herstel en duur van iedere storing

routeros_snapshot_*.txt

Handmatig of automatisch opgehaalde RouterOS-informatie
